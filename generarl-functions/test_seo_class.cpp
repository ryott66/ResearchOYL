...
protected:
    ...
    void SetUp() override {
        ...
        (*seoGrid).at(0).at(0).at(0)->setConnection((*seoGrid).at(1).at(0).at(0));
        (*seoGrid).at(0).at(0).at(0)->setConnection((*seoGrid).at(0).at(1).at(0));
        (*seoGrid).at(0).at(0).at(0)->setConnection((*seoGrid).at(0).at(0).at(1));
    }
};
